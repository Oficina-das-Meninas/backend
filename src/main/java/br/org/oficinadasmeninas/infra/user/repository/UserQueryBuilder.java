...
public class UserQueryBuilder {
    ...
    public static final String FIND_ALL_USERS = "SELECT id, name, email, password, phone, document, is_inactive FROM users";

    public static final String FIND_USER_BY_ID = "SELECT id, name, email, password, phone, document, is_inactive FROM users WHERE id = ?";

    public static final String FIND_USER_BY_EMAIL = "SELECT id, name, email, password, phone, document, is_inactive FROM users WHERE email = ?";

    public static final String INSERT_USER = "INSERT INTO users (id, name, email, password, phone, document, is_inactive) VALUES (?, ?, ?, ?, ?, ?, ?)";
